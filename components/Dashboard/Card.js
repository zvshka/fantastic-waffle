        ...
        <div
            ...
            <div className="flex sm:flex-1 flex-col gap-2 p-1">
                ...
                <div className="flex gap-4 mt-auto">
                    <button
                        className='flex items-center gap-1 text-lg border border-gray-300 px-3 py-1 rounded-full hover:bg-gray-50 transition-colors focus:bg-gray-100 focus:outline-none focus-visible:border-gray-500'
                    >
